...
NUM_TRHEADS = 36 
NUM_FOLDERS = 100 
DATA_FOLDER = "/home/malacca/3DLLM/data/cad_data"  # 直接在代码中设置数据文件夹路径
OUT_FOLDER = "/home/malacca/3DLLM/data/cad_data_normalized"  # 直接在代码中设置输出文件夹路径
...
def run_parallel(project_folder):
    ...
    output_folder = os.path.join(OUT_FOLDER, subfolder1, subfolder2)

    extrude_param = find_files(os.path.join(DATA_FOLDER, subfolder1, subfolder2), 'param.obj') 
